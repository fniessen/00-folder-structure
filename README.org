...
│   ├── *Home*
│   │   ├── *0-Property-Documents* (or House-Documents): Deed, mortgage documents, and title.
│   │   ├── *1-Utilities*: Electricity, gas, water, and internet bills.
│   │   ├── *2-Maintenance* (and Repairs): Logs, receipts, warranties, and service agreements.
│   │   ├── *3-Renovations*: Plans, quotes, and invoices for major upgrades.
│   │   │   ├── Kitchen-Renovation
│   │   │   ├── Garden-Landscaping
│   │   │   └── DIY-Furniture
│   │   └── 4-Home-Insurance ???
